# GradientLander
A game created to expand ones understanding of Gradient Descent. The current model uses agentic coding (Codex) and Unity to build.

Game currently uses a simplified, one dimensional version of the gradient descent equation. The player selects a map and must adjust weight and bias to land the spaceship on the target at the bottom.
